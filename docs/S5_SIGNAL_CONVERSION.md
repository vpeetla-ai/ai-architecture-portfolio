# S5 — Signal + conversion pack

**Status:** ACTIVE (2026-07-18)  
**Plan:** [`TOP1PCT_90DAY_EXECUTION.md`](./TOP1PCT_90DAY_EXECUTION.md) · Decision **D4** (LinkedIn + Substack from ADRs) · **D5** (Staff+/Principal offers)
...
1. https://venkat-ai.com/technical-review  
2. https://venkat-ai.com/spine-health  
3. [GOLDEN_PATH.md](./GOLDEN_PATH.md)  
4. https://venkat-ai.com/hire  
5. https://ai-architect-interview-playbook.vercel.app → Practice Arena  

## Anti-pattern (D4)

Do **not** lead with “launched another demo.” Lead with a **decision** (ADR), a **trade-off**, and a **live proof link**.
