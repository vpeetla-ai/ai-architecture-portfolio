...
| [aegis-llm-gateway](https://github.com/vpeetla-ai/aegis-llm-gateway) | Shared OpenAI-shaped LLM completions plane (ADR-028) | [07 LLM gateway / semantic cache](https://ai-architect-interview-playbook.vercel.app/q/cloud-architecture/07-llm-gateway-semantic-cache-model-router/) | trade-off 01 · FinOps pre-flight |
